...
public class LearnExceptionTest {
    ...
    public void testGlobal() {
        ...
        double res= 0.0;
        try{
            res = LearnException.Divider.divide(i1, i2);
        ...
        i1 = 5;
        i2 = 0;
        correct = LearnException.Divider.canDivide(i1, i2);
        ...
        i2 = 2;
        try{
            res = LearnException.Divider.betterDivide(i1, i2);
        }catch(ArithmeticException e){
            correct = false;
        }
        ...
        i1 = 5;
        i2 = 2;
        String s = LearnException.Divider.betterCanDivide(i1, i2);
        ...
        i1 = 5;
        i2 = 0;
        s = LearnException.Divider.betterCanDivide(i1, i2);
