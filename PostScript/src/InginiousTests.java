...
public class InginiousTests {
    ...
    @Test
    @Grade
    @GradeFeedback(message = "Adding a floating point value and an integer yields a floating point value\n", onFail = true, onTimeout = true)
    public void addDoubleAndIntOperands(){
        Assert.assertEquals(
                            "Adding a floating point value and an integer yields a floating point value",
